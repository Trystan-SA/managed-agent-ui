...
| 2.0.0 | [Authentication & Security](./2.0.0-auth.md) | Registration, login, encryption, sessions |
...
| 8.0.0 | [Settings & Preferences](./8.0.0-settings.md) | API key management, theme, defaults |
